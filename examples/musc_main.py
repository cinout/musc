...
def get_args():
    ...
    parser.add_argument(
        "--config", type=str, default="./configs/musc.yaml", help="config file path"
    )
    ...
    parser.add_argument(
        "--vis_type", type=str, default=None, help="normalization type in visualization"
    )
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=None,
        help="aggregation degrees of LNAMD",
    )
    parser.add_argument(
        "--feature_layers", type=int, nargs="+", default=None, help="feature layers"
    )
    parser.add_argument("--backbone_name", type=str, default=None, help="backbone")
    parser.add_argument(
        "--pretrained", type=str, default=None, help="pretrained datasets"
    )
    parser.add_argument("--img_resize", type=int, default=None, help="image size")
    parser.add_argument("--batch_size", type=int, default=None, help="batch size")
    parser.add_argument(
        "--divide_num", type=int, default=None, help="the number of divided subsets"
    )
    parser.add_argument(
        "--online",
        action="store_true",
        help="only use the current batch to perform anomaly prediction (challenging)",
    )
